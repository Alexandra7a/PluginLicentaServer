...
class CodePreprocessor:
    ...
    def remove_comments(java_code):
        import re
        """removes both singleline (//text) and multiline (/*text*/)
        while preventing removal of strings which contains stings inside of them"""
        if not isinstance(java_code, str):
            return java_code
...
class VulnerabilityDetectionModel:
    ...
    def evaluate(self, X_test, y_test):
        ...
        #print(classification_report(y_test, y_pred_classes, target_names=["NotVulnerable", "Vulnerable"]))
